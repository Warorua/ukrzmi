...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Manually input Data</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
  ...
  $search_where = " WHERE category <> 'international' input IS NOT NULL
                " . $type_fin . "
                " . $tag_1_fin . "
                " . $tag_2_fin . "
                " . $tag_3_fin . "             
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Data manually input.</h3>
              ...
              <div class='row d-flex justify-content-between'>
                ...
                <div class="col-md-2">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    location.replace('manual_view.php?tag_1=<?php echo (isset($_GET['tag_1'])) ? $_GET['tag_1'] : '' ?>&tag_2=<?php echo (isset($_GET['tag_2'])) ? $_GET['tag_2'] : '' ?>&tag_3=<?php echo (isset($_GET['tag_3'])) ? $_GET['tag_3'] : '' ?>&type=<?php echo (isset($_GET['type'])) ? $_GET['type'] : '' ?>&tag_id=<?php echo (isset($_GET['tag_id'])) ? $_GET['tag_id'] : '' ?>&length='+this.value)
                    ">
                ...
                <div class="col-md-2">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    location.replace('manual_view.php?tag_1=<?php echo (isset($_GET['tag_1'])) ? $_GET['tag_1'] : '' ?>&tag_2=<?php echo (isset($_GET['tag_2'])) ? $_GET['tag_2'] : '' ?>&tag_3=<?php echo (isset($_GET['tag_3'])) ? $_GET['tag_3'] : '' ?>&length=<?php echo (isset($_GET['length'])) ? $_GET['length'] : 8 ?>&tag_id=<?php echo (isset($_GET['tag_id'])) ? $_GET['tag_id'] : '' ?>&type='+this.value)
     ">
                ...
                <div class="col-md-2">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    location.replace('manual_view.php?type=<?php echo (isset($_GET['type'])) ? $_GET['type'] : '' ?>&tag_2=<?php echo (isset($_GET['tag_2'])) ? $_GET['tag_2'] : '' ?>&tag_3=<?php echo (isset($_GET['tag_3'])) ? $_GET['tag_3'] : '' ?>&length=<?php echo (isset($_GET['length'])) ? $_GET['length'] : 8 ?>&tag_id=<?php echo (isset($_GET['tag_id'])) ? $_GET['tag_id'] : '' ?>&tag_1='+this.value)
     ">
                ...
                <div class="col-md-2">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    location.replace('manual_view.php?type=<?php echo (isset($_GET['type'])) ? $_GET['type'] : '' ?>&tag_1=<?php echo (isset($_GET['tag_1'])) ? $_GET['tag_1'] : '' ?>&tag_3=<?php echo (isset($_GET['tag_3'])) ? $_GET['tag_3'] : '' ?>&length=<?php echo (isset($_GET['length'])) ? $_GET['length'] : 8 ?>&tag_id=<?php echo (isset($_GET['tag_id'])) ? $_GET['tag_id'] : '' ?>&tag_2='+this.value)
     ">
                ...
                <div class="col-md-2">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    location.replace('manual_view.php?type=<?php echo (isset($_GET['type'])) ? $_GET['type'] : '' ?>&tag_1=<?php echo (isset($_GET['tag_1'])) ? $_GET['tag_1'] : '' ?>&tag_2=<?php echo (isset($_GET['tag_2'])) ? $_GET['tag_2'] : '' ?>&length=<?php echo (isset($_GET['length'])) ? $_GET['length'] : 8 ?>&tag_id=<?php echo (isset($_GET['tag_id'])) ? $_GET['tag_id'] : '' ?>&tag_3='+this.value)
     ">
                ...
                <div class="col-md-1">
                  <div class=" mb-3">
                    <button class="btn btn-warning" onclick="location.replace('manual_view.php')"><i class="fa fa-undo" aria-hidden="true"></i></button>
                  </div>
                </div>
