...
if($nav_link == 'manual_view.php' || $nav_link == 'auto_view.php'){
  $news_1 = 'menu-open';
  $news_2 = 'active';
  //nav specific
  $manual_view = 'active';
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home.php" class="brand-link">
      <img src="../bower/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php echo $dashboard_1 ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link <?php echo $dashboard_3 ?>">
