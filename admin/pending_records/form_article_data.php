              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Article Title" value="<?php echo $data['title'] ?>" required>
                  </div>
...
';
  ...
  ?>
             ...
             <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="deep_link" name="deep_link" placeholder="Article Deep Link"  value="<?php echo $data['deep_link'] ?>" required>
                  </div>
             </div>
         </div>
...
if($data['type'] == 'video'){
  ...
  <div class="form-group">                  
  <input type="url" class="form-control" id="video_url" name="video_url" value="'.$data['video_url'].'" placeholder="Video Link" required>              
      </div>
  </div>
  ';
}
