...
<div class="username-challenge" id="login-landing">
    <strong class="challenge-heading">Sign up</strong>
    <span class="challenge-desc signin-sub-title">Sign up using your email address.</span>
    </span>
    <form action="reg_process.php" method="post" class="pure-form">
        ...
        <div class="button-container">
            <input id="login-signin" type="submit" name="signup" class="pure-button puree-button-primary challenge-button" value="Sign Up" data-rapid-tracking="true" data-ylk="elm:btn;elmt:primary;slk:next;mKey:next" />
        </div>
        ...
        <div class="bottom-links-container has-social-buttons">
            <p class="sign-up-link">
                <a href="login.php" id="createacc" role="button" class="pure-button puree-button-secondary challenge-button" data-rapid-tracking="true" data-ylk="elm:link;elmt:secondary;slk:signup;mKey:signup">Log in</a>
            </p>
