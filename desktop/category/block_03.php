...
<div style="background-color:<?php echo $block[2]['bg_color']; ?>" class="cardBlock row carousel-<?php echo $sub_cat_rule; ?>">
...
<div style="background-color:<?php echo $block[2]['bg_color']; ?>" class="cardBlock row">
