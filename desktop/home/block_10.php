...
<div style="background-color:<?php echo $block[9]['bg_color']; ?>" class="cardBlock row carousel-<?php echo $block[9]['name']; ?>">
...
$('.carousel-<?php echo $block[9]['name']; ?>').on('init',function(event, slick){
  document.getElementById('carPrev<?php echo $block[9]['id']; ?>').style.visibility = 'hidden';
});
...
$('.carousel-<?php echo $block[9]['name']; ?>').on('afterChange', function(event, slick, currentSlide){
  ...
  if (CarNo==0) {
    ...
    document.getElementById('carPrev<?php echo $block[9]['id']; ?>').style.visibility = '';
  }
  if (CarNo==<?php echo $slide_control; ?>) {
    //alert('this is page 0')
    document.getElementById('carNext<?php echo $block[9]['id']; ?>').style.visibility = 'hidden';
  }
else if(CarNo!=<?php echo $slide_control; ?>){
    document.getElementById('carNext<?php echo $block[9]['id']; ?>').style.visibility = '';
  }
