...
foreach($intern_block as $row){
    ...
    ';
            ...
            <div class="mb-3">
                ...
                We aim to cover the most relevant sources worldwide in this fragment. Fell free to recommend new ones <a href="mailto:admin@ukrzmi.com" style="color: #000000">here</a>.
                </p>
            </div>
                </div>
