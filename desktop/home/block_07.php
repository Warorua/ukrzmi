...
<div style="background-color:<?php echo $block[6]['bg_color']; ?>" class="row cardPanel pb-2">
 ...
 <button id="carPrev<?php echo $block[6]['name']; ?>" type="button" data-role="" class="slickk-prev-<?php echo $block[6]['name']; ?> btn btn-outline-dark btn-sm" <?php if(isset($hide_control_button)){echo $hide_control_button;} ?>>Previous</button>
  
<button id="carNext<?php echo $block[6]['name']; ?>" type="button" data-role="" class="slickk-next-<?php echo $block[6]['name']; ?> btn btn-outline-dark btn-sm" <?php if(isset($hide_control_button)){echo $hide_control_button;} ?>>Next</button>
  </div>
