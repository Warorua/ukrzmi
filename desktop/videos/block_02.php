...
$('.carousel-<?php echo $block[1]['name']; ?>').on('init',function(event, slick){
  document.getElementById('carPrev<?php echo $block[1]['id']; ?>').style.display = 'none';
});
...
$('.carousel-<?php echo $block[1]['name']; ?>').on('afterChange', function(event, slick, currentSlide){
  ...
  if (CarNo==0) {
    ...
    document.getElementById('carPrev<?php echo $block[1]['id']; ?>').style.display = '';
  }
  if (CarNo==<?php echo $slide_control; ?>) {
    //alert('this is page 0')
    document.getElementById('carNext<?php echo $block[1]['id']; ?>').style.display = 'none';
  }
else if(CarNo!=<?php echo $slide_control; ?>){
    document.getElementById('carNext<?php echo $block[1]['id']; ?>').style.display = '';
  }
