<div class="">
  <div class="d-flex justify-content-between">
    ...
    <div class="<?php if (isset($_GET['A0034'])) {
    ...
    <div class="">
      <ul class="nav justify-content-end" id="myTab">
        ...
        <li class="nav-item" role="presentation">
          <a class="nav-link active" id="grid-tab" data-bs-toggle="tab" data-bs-target="#grid" type="a" role="tab" aria-controls="grid" aria-selected="true"><i class="fa fa-th text-dark" aria-hidden="true"></i></a>
        </li>
