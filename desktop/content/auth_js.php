...
///PRAVDA
  $(document).ready(function(){
$("a[href='https://t.me/EurointegrationComUA'], ins[class='adsbygoogle'], div[class='article__title'], div[id='div-gpt-ad-1637938597466-0'], div[class='image-box'], a[href='https://www.patreon.com/EuropeanPravda'], table img, div[class='club_banner_1']").remove();
});
  </script>
  <script>
    ////korrespondent
