  ...
  <div class="row topRow">
    ...
    <div class="col-md-7">
      <div class="row">
        ...
        <div style="margin-left:-20px" class="col-md-1"><a href="home.php" style="text-decoration: none" class="text-white">
            <div class="topLogo">U</div>
          </a></div>
        <div class="col-md-1">
          <a href="home.php" style="text-decoration: none" class="text-white">
            <p class="text-light topLogoText">Ukrzmi</p>
          </a>
        </div>
    ...
    <div class="col-md-1 h-100">
      <div class="topBlockA_1">
        <h5 class="topBlockA_2_text">BLOG</h5>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <ul class="nav topNav justify-content-end">
        <li class="nav-item">
          <a class="nav-link btn btn-dark btn-sm text-light" style="width:100%" href="../membership/register.php">Sign in</a>
        </li>
