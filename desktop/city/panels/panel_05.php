...
<div class="card-body d-flex justify-content-center h-75">
          ...
          <a class="stretched-link" href="all_content.php?page=<?php echo $pageName ?>&block_id=<?php echo $block_id ?>&cat_id=<?php echo $block[$block_id]['name'] ?>&cat_type_three=<?php echo $_GET['id'] ?>"></a>
    </div>
  </div>
  </div> 
 </div>
