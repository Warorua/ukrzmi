...
if($block[$block_id]['active'] == 1){
  ...
  $stmt->execute(['cat_not'=>'international', 'page'=>'', 'type'=>"", 'pin'=>1, 'block_id'=>$block[$block_id]['id'], 'page'=>'']);
...
<!----------------
<div class="">   
  <div class="card w-100 clearfix cardSet " style="background-color:'.$block[$block_id]['bg_color'].'">
 
  <div class="d-flex justify-content-between">
  <div class="imgTitle w-50">
         <p class="blogTitle">'.$rowParent.'</p>
        <div class="cardFrame" style="border-color: '.$frameColor.';"></div>
        <img src="https://www.ukrzmi.com/images/'.$row['photo'].'" class=" cardPhoto_2" alt="'.$row['title'].'">
    </div>
   ...
   <div class="card-body w-50">
        <div class="card-title blockTitle">'.$titleBadge.''.$rowtitle.'</div>
    <a href="#"></a>  
  </div>
  </div>
