...
<div style="background-color:<?php echo $block[2]['bg_color']; ?>" class="cardBlock carousel-<?php echo $block[2]['name']; ?>">
...
<div style="background-color:<?php echo $block[2]['bg_color']; ?>" class="cardBlock container">
  <div class="d-flex justify-content-between">
   <button id="carPrev<?php echo $block[2]['name']; ?>" type="button" data-role="" class="slickk-prev-<?php echo $block[2]['name']; ?> btn btn-outline-dark btn-sm w-25" <?php if(isset($hide_control_button)){echo $hide_control_button;} ?>>Previous</button>
  <button id="carNext<?php echo $block[2]['name']; ?>" type="button" data-role="" class="slickk-next-<?php echo $block[2]['name']; ?> btn btn-outline-dark btn-sm w-25" <?php if(isset($hide_control_button)){echo $hide_control_button;} ?>>Next</button>
  </div>
