...
<div class="col-md-3">
 <div class="imgFrame">
  ...
  <img class="cardPhotoList_2" src="https://www.ukrzmi.com/images/'.$row['photo'].'" height="130px" alt="'.$row['title'].'" />
   </div>
   </a> 
   </div> 
</div>
...
$('.load-more').click(function(){
    ...
    if(row <= allcount){
        ...
        $.ajax({
            url: 'category/headlines/list_data.php',
            type: 'post',
            data: {row:row},
            beforeSend:function(){
