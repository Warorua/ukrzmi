...
<div style="background-color:<?php echo $block[1]['bg_color']; ?>" class="cardBlock carousel-<?php echo $sub_cat_rule; ?>">
...
<div style="background-color:<?php echo $block[1]['bg_color']; ?>" class="cardBlock container">
