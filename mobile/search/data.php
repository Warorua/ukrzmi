...
$art_cont = substr(strip_tags($row['article']),0,200).'...';

          echo '
  <li class="list-group-item border rounded post">
...
<div class="d-grid gap-2 d-flex justify-content-center mt-4 mb-3">
 <button type="button" class="load-more btn btn-primary w-75 <?php echo $btnSet ?>">
 Load More
</button>
</div>
