...
<div class="w-100 d-flex justify-content-between">
 ...
 ORDER BY id DESC LIMIT 48");
  ...
  $stmt->execute(['cat_not'=>'international', 'page'=>'interview', 'type'=>"", 'pin'=>1, 'block_id'=>$block[$block_id]['id']]);
...
if($row['title_badge'] == ""){
  ...
  $titleBadge = '<img src="../admin/'.$row['title_badge'].'" class="titleBadge" />';
      ...
      echo '
  <div class="w-50">    
  <div class="card" style="background-color:'.$block[$block_id]['bg_color'].'">
...
<a href="article_content.php?code='.$row['code'].'" class="stretched-link"></a>  
    ...
    <div style="height:110px; width:100%; margin-top:3px" class="bg-dark card-body p-1">  
